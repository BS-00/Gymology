...
function IncNumInput(props: {onChange: (val: number) => void, minVal: number, id: string, label: string, amnt?: number}): React.ReactElement {
	...
	return (
		<div className="my-2 form-group">
			...
			<div className="input-group">
			    ...
			    <input onChange={e => props.onChange(Number(e.target.value))} ref={inputRef} id={props.id} type="number" min={props.minVal} className="form-control" defaultValue={props.minVal}/>
